 ...
 */
public final class AkaiFatFileSystem extends AbstractFileSystem {
    
    private final Fat fat;
    private final FsInfoSector fsiSector;
    private final BootSector bs;
    private final AkaiFatLfnDirectory rootDir;
    private final AbstractDirectory rootDirStore;
    private final FatType fatType;
    private final long filesOffset;

    AkaiFatFileSystem(BlockDevice api, boolean readOnly) throws IOException {
     ...
     */
    private AkaiFatFileSystem(BlockDevice device, boolean readOnly,
        ...
        this.rootDir = new AkaiFatLfnDirectory(rootDirStore, fat, isReadOnly());
     ...
     *      not be parsed
     */
    public static AkaiFatFileSystem read(BlockDevice device, boolean readOnly)
            throws IOException {
