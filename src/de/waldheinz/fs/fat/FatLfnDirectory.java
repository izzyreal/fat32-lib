...
public final class FatLfnDirectory
    ...
    private boolean checkUniqueAkaiName(String name) {
        final String lowerName = name.toLowerCase(Locale.ROOT);
//    	String part1 = splitName(lowerName)[0];
//    	String part2 = "";
//    	String ext = splitName(lowerName)[1];
//    	if (part1.length() > 8) {
//    		part2 = part1.substring(8);
//    		part1 = part1.substring(0, 8);
//    	}
//    	
//    	boolean uniqueShort = true;
//    	try {
