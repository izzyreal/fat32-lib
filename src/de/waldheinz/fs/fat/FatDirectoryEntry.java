...
final class FatDirectoryEntry extends AbstractFsObject {
    ...
    public void setAkaiName(String s) {
    	System.out.println("string s " + s);
    	String part1 = AkaiFatLfnDirectory.splitName(s)[0];
    	String part2 = "        ";
    	String ext = AkaiFatLfnDirectory.splitName(s)[1];
    	if (part1.length() > 8) {
    		part2 = part1.substring(8);
    		part1 = part1.substring(0, 8);
    	}
    	if (ext.length() > 0) ext = "."+ ext;
    	final ShortName sn = new ShortName(part1 + ext);
    	sn.write(this.data);
    	System.out.println( "part 1 " + part1);
    	System.out.println( "part 2 " + part2);
    	final AkaiPart ap = new AkaiPart(part2);
    	ap.write(this.data);
    }
