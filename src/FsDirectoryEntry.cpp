...
public interface FsDirectoryEntry extends FsObject {
     ...
     * before all files.
     */
    public const static Comparator<FsDirectoryEntry> DIRECTORY_ENTRY_COMPARATOR =
     ...
     * @throw (std::exception) on error setting the new name
     */
    public void setName(std::string newName) throws IOException;
     ...
     * @throw (std::exception) on error accessing the file
     */
